...
@Schema(description = "내 약 조회 요청-보안문자 검증")
data class SmsVerifyRequest (
    ...
    @field:Schema(description = "보안 문자 번호", required = true, example = "123456")
    @field:Pattern(regexp = "^[0-9]{6}$", message = "보안 문자 인증은 6자리 숫자입니다.")
