...
class PrescriptionParser(
    ...
    fun parsePostInferenceResponse(): OcrResponse {
        ...
        postInferenceResponse.prediction.keyValues
    ...
    private fun checkAndSetSelfPayRateCode(prescriptionContent: PrescriptionContent) {
        ...
        val defaultSelfPayRateCode: SelfPayRateCode =
            SelfPayRateCode(SelfPayRateCodeEnum.REIMBURSEMENT.word, drugNameNeedCheck)
        ...
        if (selfPayRateCodeString == null && drugName != null) {
            ...
            prescriptionContent.selfPayRateCode = defaultSelfPayRateCode
        } else if (selfPayRateCodeString != null && drugName != null) {
    ...
    companion object {
        ...
        val SELF_PAY_RATE_KEYWORDS: Map<String, Set<String>> = mapOf(
            SelfPayRateCodeEnum.REIMBURSEMENT.word to setOf(
                "급여",
                "[급여]",
                "급여)",
                "(급여)",
            ...
            SelfPayRateCodeEnum.NON_REIMBURSEMENT.word to setOf(
                "비)",
                "(비)",
                "비 ",
                "[비]",
            ...
            SelfPayRateCodeEnum.SELF_PAY_100.word to setOf(
                "본)",
                "(본)",
                "본 ",
                "[본]",
            ...
            SelfPayRateCodeEnum.SELF_PAY_80.word to setOf(
                "80/100",
                "(80/100)",
                "80/100)",
                "[80/100]",
            ...
            SelfPayRateCodeEnum.SELF_PAY_50.word to setOf(
                "50/100",
                "(50/100)",
                "50/100)",
                "[50/100]",
            ...
            SelfPayRateCodeEnum.SELF_PAY_30.word to setOf("D ", "(D)", "D)", "[D]")
        )
